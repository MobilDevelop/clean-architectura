...
final class DarkModeColor extends BaseColors {
  const DarkModeColor();
  ...
  @override
  Color get textGraySoft => const Color.fromRGBO(33, 33, 33, 1);
  ...
  @override
  Color get infoToast => const Color.fromRGBO(255, 180, 0, 1);
